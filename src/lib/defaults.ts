...
export const DEFAULT_VENTURES: Venture[] = [
  {
    ...
    label: "ONLINE ACADEMIC SOFTWARE SUPPORT",
    theme: "project",
    heroImage: "/images/project-visual.svg",
    description:
      "An online platform helping college students build, understand, and complete academic software projects with professional development support.",
    headline: ["BUILD SOFTWARE.", "UNDERSTAND MORE.", "COMPLETE WITH CONFIDENCE."],
    features: [
  ...
  },
  {
    ...
    label: "100% ONLINE 1:1 TUTORING",
    theme: "learning",
    heroImage: "/images/learning-visual.svg",
    description:
      "One student. One dedicated tutor. Personalized online classes with individual attention, flexible learning, and easy communication from anywhere.",
    headline: ["ONE STUDENT.", "ONE TUTOR.", "ONE FOCUSED EXPERIENCE."],
    features: ["1 : 1 Dedicated Tutoring", "Personalized Online Classes", "Learn From Anywhere", "Easy Tutor Communication", "Individual Progress Support", "Flexible Modern Learning"],
